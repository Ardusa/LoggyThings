...
public class LoggyCANcoder extends CANcoder implements ILoggyMotor {
     ...
     */
    public LoggyCANcoder(int deviceNumber, String canbus, String logPath, EnumSet<ILoggyMotor.LogItem> logLevel) {
     ...
     * @param logLevel     see {@link ILoggyMotor.LogItem}
     */
    public LoggyCANcoder(int deviceNumber, String logPath, EnumSet<ILoggyMotor.LogItem> logLevel) {
     ...
     * @param logPath      String path of log file
     */
    public LoggyCANcoder(int deviceNumber, String logPath) {
     ...
     * @param deviceNumber CAN id
     */
    public LoggyCANcoder(int deviceNumber) {
